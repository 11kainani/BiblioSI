...
public class HomeServlet extends HttpServlet {
    ...
    @EJB
    private LivreBusinessLocal livre;
    @EJB
    private GenreBusinessLocal genre;
    @EJB
    private UtilisateurBusinessLocal utilisateur;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        HttpSession session = request.getSession();
        UtilisateurBean utilisateur = (UtilisateurBean) session.getAttribute("UTILISATEUR");
        Integer IdLivre = Integer.parseInt(request.getParameter("reserverBookId"));
        ...
        if (utilisateur.getListLivres().size() < 5 && newLivre.getLibre()) {
            ...
            reservedStatus = "reservation impossible vous avez depasse la limite d'emprunt (5 livres/personne)";
        }
